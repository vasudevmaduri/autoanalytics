...
def get_entities(file):
    ...
    df_input["sentiment"] = 0
    df_input["magnitude"] = 0
    ...
    for i in df_input.index:
        ...
        print(i)
        text_cleaned = df_input["text"][i]
        score, magnitude = analyze_text_sentiment(text_cleaned)

        df_input["sentiment"].loc[i]=score
        df_input["magnitude"].loc[i]=magnitude
...
get_entities("results_per_video_v1.csv").to_csv("results_per_video_v2.csv")
